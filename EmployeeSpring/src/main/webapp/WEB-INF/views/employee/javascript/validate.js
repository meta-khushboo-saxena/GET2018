...
function validateName(name){
	...
	if(!(/^[a-zA-Z]{2,}$/.test(name.value))){
		 ...
		 if(name == document.getElementById('first_name') && name.value != ""){
		 ...
		 }else if (name == document.getElementById('first_name') && name.value == ""){
			 name.style.borderColor="red";
			 document.getElementById('checkfirstname').innerHTML = "enter firstname";
			 document.getElementById('checkfirstname').style.color = "red";
		 }else if(name == document.getElementById('last_name') && name.value != "") {
			 ...
			 document.getElementById('checklastname').style.color = "";
		 }
	}else {
...
function checkAge(){
	if(document.getElementById('age').value != ""){
		document.getElementById('checkAge').innerHTML = "&#10004";
		document.getElementById('checkAge').style.color = "green";
		document.getElementById('age').style.borderColor="green";
		return true;
	}
	document.getElementById('checkAge').innerHTML = "enter age";
	document.getElementById('checkAge').style.color = "red";
...
function checkDob(){
	if(document.getElementById('dob').value != ""){
		document.getElementById('checkDob').innerHTML = "&#10004";
		document.getElementById('checkDob').style.color = "green";
		document.getElementById('dob').style.borderColor="green";
		return true;
	}
	document.getElementById('checkDob').innerHTML = "enter date of birth";
	document.getElementById('checkDob').style.color = "red";
