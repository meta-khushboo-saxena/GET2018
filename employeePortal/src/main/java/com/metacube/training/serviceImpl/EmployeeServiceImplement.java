...
public class EmployeeServiceImplement implements EmployeeServiceInterface {
	...
	public Boolean insertToken(ForgotPasswordToken forgotPasswordToken) {
		return employeeDAO.insertToken(forgotPasswordToken);
	}
	...
	public ForgotPasswordToken getToken(String email) {
		...
		if (employeeDetail != null) {
			...
			forgotPasswordToken.setToken(employeeDetail.getToken());
	...
	public Boolean deleteToken(String email) {
		return employeeDAO.deleteToken(email);
	}

	@Override
	public Boolean reset(String email, String password) {
		return employeeDAO.reset(email, password);
	}
