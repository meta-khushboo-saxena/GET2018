...
import com.metacube.training.dto.LoginDetail;
...
public class EmployeeController {
	...
	public String login(@ModelAttribute("loginDetail") LoginDetail loginDetail,
			Model model) {
		String view;
		if (employeeService.validateLogin(loginDetail.getEmail(),
				loginDetail.getPassword())) {
			session.setAttribute("email", loginDetail.getEmail());
			view = "employee/dashboard";
			model.addAttribute("email", loginDetail.getEmail());
		} else {
			view = "employee/login";
